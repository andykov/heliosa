...
/* harmony import */ var _modules_galleryRecommend__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/galleryRecommend */ "./app/js/modules/galleryRecommend.js");
/* harmony import */ var _modules_galleryTabs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/galleryTabs */ "./app/js/modules/galleryTabs.js");
/* harmony import */ var _modules_productQuantity__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/productQuantity */ "./app/js/modules/productQuantity.js");
/* harmony import */ var _modules_productQuantity__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_modules_productQuantity__WEBPACK_IMPORTED_MODULE_9__);
...
if (dropdowns.length) {
  dropdowns.forEach(function (elem) {
    var DropdownInit = new _modules_dropdown_native__WEBPACK_IMPORTED_MODULE_2___default.a(elem);
    DropdownInit.dispose(); // DropdownInit.getSelected();
  });
  ...
  function Dropdown(element, option) {
    ...
    checkboxes.forEach(function (item, i) {
      ...
      if (item.checked) {
        ...
        var span = queryElement('span', _parent);
      ...
      item.addEventListener('change', function () {
        ...
        checkboxes.forEach(function (input, i) {
          if (input.checked) {
            var _parent2 = input.parentNode;

            var _span = queryElement('span', _parent2);
    ...
    if (clear) {
      clear.addEventListener('click', function (e) {
        ...
        label.textContent = labelDefault; // self.toggle();
      });
...
function setLabelActiveTab(data) {
  ...
  var parent = data.tab.closest('.tabs-nav'); // console.log(parent);
