...
if (bannerCollectionElem) {
  ...
  splide.mount();
  var arrows = splide.Components.Arrows.arrows.next.parentNode;
  var arrowNext = splide.Components.Arrows.arrows.next;
  var pagination = splide.Components.Pagination.data.list;
  var w = arrowNext.clientWidth * 2 + (pagination.clientWidth + 40);

  if (window.screen.width < 992) {
    arrows.style.maxWidth = "".concat(w, "px");
  }
}
    ...
    tab.addEventListener('click', function (e) {
      ...
      if (Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_0__["isHidden"])(galleryWrap)) {
        ...
        if (!isActive) {
          ...
          g.on('mounted', Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_0__["setCurrentIndexSLide"])(g));
          g.on('move', function (newIndex) {
            Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_0__["setCurrentIndexSLide"])(g, newIndex);
          });
        }
      } // remove
...
if (sliderHistoryElem) {
  ...
  if (window.innerWidth >= 640 && window.innerWidth <= 991 || window.innerWidth >= 992 && window.innerWidth <= 1239) {
...
function setPaddingSlider(slider, perPage) {
  ...
  var calcPadding = (widthWindow - containerWidth) / 2; // Без этого криво работает пролистывание, если в опции perpage
  ...
  if (slider && perPage) {
    var gap = slider.options.gap * (perPage - 1);
    var paddingRight = containerWidth - (containerWidth - gap) / perPage;
...
/*!*********************************!*\
  !*** ./app/js/utils/helpers.js ***!
  \*********************************/
/*! exports provided: isHidden, isOutSideClick, getSiblings, setCurrentIndexSLide, onMountedHideArrowsSlider, overlayVisibility, optimizedResize */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "optimizedResize", function() { return optimizedResize; });
